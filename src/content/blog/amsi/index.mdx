...
description: 'Reverse‑engineering AMSI and implementing a memory‑patch.'
date: 2025-11-15
...
|:--:|
| *Image from GFG on "How C# gets compiled" [^1]* |

[^1]: [How C# Code Gets Compiled and Executed?](https://www.geeksforgeeks.org/c-sharp/how-c-sharp-code-gets-compiled-and-executed/)
